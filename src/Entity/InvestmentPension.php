...
use App\Repository\InvestmentPensionRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=InvestmentPensionRepository::class)
 */
class InvestmentPension
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Investment::class, inversedBy="investmentPensions")
     */
    private $investment;
