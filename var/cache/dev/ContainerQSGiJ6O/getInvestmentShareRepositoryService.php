 ...
 */
class getInvestmentShareRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InvestmentShareRepository' shared autowired service.
     *
     * @return \App\Repository\InvestmentShareRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InvestmentShareRepository.php';

        return $container->privates['App\\Repository\\InvestmentShareRepository'] = new \App\Repository\InvestmentShareRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
