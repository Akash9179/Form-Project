 ...
 */
class getEmotionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmotionsRepository' shared autowired service.
     *
     * @return \App\Repository\EmotionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmotionsRepository.php';

        return $container->privates['App\\Repository\\EmotionsRepository'] = new \App\Repository\EmotionsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
