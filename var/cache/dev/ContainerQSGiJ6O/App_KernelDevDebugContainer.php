...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HtDVgQqOpA', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0wQYWJopNC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SAgDWvroI5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\ArtCollectibleRepository' => ['privates', 'App\\Repository\\ArtCollectibleRepository', 'getArtCollectibleRepositoryService', true],
            'App\\Repository\\BusinessRepository' => ['privates', 'App\\Repository\\BusinessRepository', 'getBusinessRepositoryService', true],
            'App\\Repository\\CashRepository' => ['privates', 'App\\Repository\\CashRepository', 'getCashRepositoryService', true],
            'App\\Repository\\DesireRepository' => ['privates', 'App\\Repository\\DesireRepository', 'getDesireRepositoryService', true],
            'App\\Repository\\EmotionsRepository' => ['privates', 'App\\Repository\\EmotionsRepository', 'getEmotionsRepositoryService', true],
            'App\\Repository\\FinanceRepository' => ['privates', 'App\\Repository\\FinanceRepository', 'getFinanceRepositoryService', true],
            'App\\Repository\\InheritanceRepository' => ['privates', 'App\\Repository\\InheritanceRepository', 'getInheritanceRepositoryService', true],
            'App\\Repository\\InvestmentAccountRepository' => ['privates', 'App\\Repository\\InvestmentAccountRepository', 'getInvestmentAccountRepositoryService', true],
            'App\\Repository\\InvestmentPensionRepository' => ['privates', 'App\\Repository\\InvestmentPensionRepository', 'getInvestmentPensionRepositoryService', true],
            'App\\Repository\\InvestmentRepository' => ['privates', 'App\\Repository\\InvestmentRepository', 'getInvestmentRepositoryService', true],
            'App\\Repository\\InvestmentShareRepository' => ['privates', 'App\\Repository\\InvestmentShareRepository', 'getInvestmentShareRepositoryService', true],
            'App\\Repository\\JobRepository' => ['privates', 'App\\Repository\\JobRepository', 'getJobRepositoryService', true],
            'App\\Repository\\PensionRepository' => ['privates', 'App\\Repository\\PensionRepository', 'getPensionRepositoryService', true],
            'App\\Repository\\PropertyRepository' => ['privates', 'App\\Repository\\PropertyRepository', 'getPropertyRepositoryService', true],
            'App\\Repository\\RentalCommercialRepository' => ['privates', 'App\\Repository\\RentalCommercialRepository', 'getRentalCommercialRepositoryService', true],
            'App\\Repository\\ResidentialLandRepository' => ['privates', 'App\\Repository\\ResidentialLandRepository', 'getResidentialLandRepositoryService', true],
            'App\\Repository\\RoyaltiesRepository' => ['privates', 'App\\Repository\\RoyaltiesRepository', 'getRoyaltiesRepositoryService', true],
            'App\\Repository\\UserAccountRepository' => ['privates', 'App\\Repository\\UserAccountRepository', 'getUserAccountRepositoryService', true],
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hUnx0JWiHW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C2LJhTp1Z5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JRaZ36XKXt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f+fUkbBYoC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wmmhzRcH4l', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
