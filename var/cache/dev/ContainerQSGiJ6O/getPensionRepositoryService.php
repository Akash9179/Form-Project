 ...
 */
class getPensionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PensionRepository' shared autowired service.
     *
     * @return \App\Repository\PensionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PensionRepository.php';

        return $container->privates['App\\Repository\\PensionRepository'] = new \App\Repository\PensionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
