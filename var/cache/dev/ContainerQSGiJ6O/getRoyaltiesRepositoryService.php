 ...
 */
class getRoyaltiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RoyaltiesRepository' shared autowired service.
     *
     * @return \App\Repository\RoyaltiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoyaltiesRepository.php';

        return $container->privates['App\\Repository\\RoyaltiesRepository'] = new \App\Repository\RoyaltiesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
