 ...
 */
class getRentalCommercialRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RentalCommercialRepository' shared autowired service.
     *
     * @return \App\Repository\RentalCommercialRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RentalCommercialRepository.php';

        return $container->privates['App\\Repository\\RentalCommercialRepository'] = new \App\Repository\RentalCommercialRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
