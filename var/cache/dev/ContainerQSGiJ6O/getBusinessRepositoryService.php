 ...
 */
class getBusinessRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BusinessRepository' shared autowired service.
     *
     * @return \App\Repository\BusinessRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BusinessRepository.php';

        return $container->privates['App\\Repository\\BusinessRepository'] = new \App\Repository\BusinessRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
