 ...
 */
class getInvestmentPensionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InvestmentPensionRepository' shared autowired service.
     *
     * @return \App\Repository\InvestmentPensionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InvestmentPensionRepository.php';

        return $container->privates['App\\Repository\\InvestmentPensionRepository'] = new \App\Repository\InvestmentPensionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
