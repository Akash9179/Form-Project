 ...
 */
class getArtCollectibleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArtCollectibleRepository' shared autowired service.
     *
     * @return \App\Repository\ArtCollectibleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArtCollectibleRepository.php';

        return $container->privates['App\\Repository\\ArtCollectibleRepository'] = new \App\Repository\ArtCollectibleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
