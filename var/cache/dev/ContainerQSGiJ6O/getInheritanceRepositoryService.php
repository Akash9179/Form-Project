 ...
 */
class getInheritanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InheritanceRepository' shared autowired service.
     *
     * @return \App\Repository\InheritanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InheritanceRepository.php';

        return $container->privates['App\\Repository\\InheritanceRepository'] = new \App\Repository\InheritanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
