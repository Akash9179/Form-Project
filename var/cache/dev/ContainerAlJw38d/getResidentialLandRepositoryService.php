 ...
 */
class getResidentialLandRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ResidentialLandRepository' shared autowired service.
     *
     * @return \App\Repository\ResidentialLandRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResidentialLandRepository.php';

        return $container->privates['App\\Repository\\ResidentialLandRepository'] = new \App\Repository\ResidentialLandRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
