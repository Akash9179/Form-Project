 ...
 */
class getInvestmentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InvestmentRepository' shared autowired service.
     *
     * @return \App\Repository\InvestmentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InvestmentRepository.php';

        return $container->privates['App\\Repository\\InvestmentRepository'] = new \App\Repository\InvestmentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
