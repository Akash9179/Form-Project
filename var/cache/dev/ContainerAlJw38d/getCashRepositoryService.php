 ...
 */
class getCashRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CashRepository' shared autowired service.
     *
     * @return \App\Repository\CashRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CashRepository.php';

        return $container->privates['App\\Repository\\CashRepository'] = new \App\Repository\CashRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
