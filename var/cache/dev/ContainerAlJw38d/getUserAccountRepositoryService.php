 ...
 */
class getUserAccountRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserAccountRepository' shared autowired service.
     *
     * @return \App\Repository\UserAccountRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserAccountRepository.php';

        return $container->privates['App\\Repository\\UserAccountRepository'] = new \App\Repository\UserAccountRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
