 ...
 */
class getDesireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DesireRepository' shared autowired service.
     *
     * @return \App\Repository\DesireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DesireRepository.php';

        return $container->privates['App\\Repository\\DesireRepository'] = new \App\Repository\DesireRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
