 ...
 */
class getInvestmentAccountRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InvestmentAccountRepository' shared autowired service.
     *
     * @return \App\Repository\InvestmentAccountRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InvestmentAccountRepository.php';

        return $container->privates['App\\Repository\\InvestmentAccountRepository'] = new \App\Repository\InvestmentAccountRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
