 ...
 */
class getFinanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FinanceRepository' shared autowired service.
     *
     * @return \App\Repository\FinanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FinanceRepository.php';

        return $container->privates['App\\Repository\\FinanceRepository'] = new \App\Repository\FinanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
